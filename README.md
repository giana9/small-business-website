...
- Replaces the headline text with the user’s input (if not empty)

This demonstrates basic DOM manipulation and event handling.
...
- Flexbox ensures clean alignment across devices
